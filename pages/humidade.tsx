...
const Humidade = () => {
  return (
    <div className="container">
      ...
      <div>
        A humidade é associada à quantidade de vapor de água existente no ar. No
        nosso sensor, esta, é medida em percentagem. A contagem é feita de
        minuto a minuto
      </div>
      <h3 className="text-center mt-5">Sensor responsavel</h3>
      <div>
        O sensor responsavel pela monitorização da humidade é o:{' '}
