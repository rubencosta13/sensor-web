...
const index = () => {
  return (
    <div className="container">
        ...
        <div>
            Este sensor, está programado para recolher dados de 60 em 60 segundos. Este, depois envia os dados para uma API, a qual é utilizada por este website.<br></br>De forma a proteger o sensor de danos ambientais, utilizamos 2. Assim não entra água no sensor, danificando-o
        </div>
